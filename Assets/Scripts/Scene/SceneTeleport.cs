...
{
    [SerializeField] private SceneName sceneNameGoto = SceneName.Scene_Farm_1;
    ...
    private void OnTriggerStay2D(Collider2D collision)
    {
        ...
        if (player != null)
        {
            ...
            SceneLoader.Instance.FadeAndLoadScene(sceneNameGoto.ToString(), new Vector3(xPosition, yPosition, zPosition));
